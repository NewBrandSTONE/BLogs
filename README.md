...
- [27 - 什么情况下重构？到底重构什么？又该如何重构？](https://github.com/NewBrandSTONE/BLogs/issues/20)
- [28 - 为了保证重构质量，有哪些非常能落地的技术手段](https://github.com/NewBrandSTONE/BLogs/issues/21)
- [29 - 什么是代码的可测试性，如何写出可测试的代码](https://github.com/NewBrandSTONE/BLogs/issues/22)
- [30 - 如何通过封装、抽象、模块化、中间层等解耦代码](https://github.com/NewBrandSTONE/BLogs/issues/23)
